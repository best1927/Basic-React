...
import RowItemDefaultpg  from './RowItemDefaultpg'; 
         ...
         <div className="frame framecss"> 
                ...
                <div className="col-md-11">
                    ...
                    <div className="list-group">
                        <div className="time-label">
                            <label className="lb-LabelBox" id="lblTodayTask">Today's Tasks </label>
            ...
            <div className="col-md-6">
                <div className="col-md-11">
                    ...
                    <div className="list-group">
                        <div className="time-label">
                            <label className="lb-LabelBox" id="lblUpcommingTask">Upcomming Tasks </label>
                            <hr className="hr-hrBox" />
                        </div>
                        <RowItemDefaultpg 
